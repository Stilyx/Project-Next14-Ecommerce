...
export const About = () => {
  return (
    <SectionCard className="mb-[12.5rem] flex w-full flex-row items-center justify-center gap-[9.813rem] tablet:mb-[6rem] tablet:flex-col-reverse tablet:items-center tablet:gap-[4.063rem] mobile:mb-[7.5rem]">
